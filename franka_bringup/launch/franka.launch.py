    ...
    return [
        ...
        Node(
            ...
            parameters=[franka_controllers,
                        ...
                        {'update_rate': 1000}  #! Ensure hardware interface runs at 1 kHz. Before this line NOT Exist
                        ],
...
def generate_launch_description():
    ...
    launch_description = LaunchDescription([
        ...
        Node(
            ...
            parameters=[
                {'source_list': ['franka/joint_states', 'franka_gripper/joint_states'],
                 'rate': 100}], #! check if the update rate could be higher before it was #30# 
        ),
        ...
        Node(
            ...
            parameters=[{'arm_id': arm_id, 'update_rate': 1000}], #! Match hardware interface rate. Before there was NO update rate
            output='screen',
