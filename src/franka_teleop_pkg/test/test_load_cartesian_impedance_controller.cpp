...
TEST(TestLoadControllers, test_load_cartesian_impedance_controller) {
  ...
  auto response = controller_manager.load_controller(
    "test_load_cartesian_impedance_controller", "franka_teleop_pkg/CartesianImpedanceController"
  );
