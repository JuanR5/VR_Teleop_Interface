...
RUN groupadd --gid $USER_GID $USERNAME \
    ...
    && chown $USERNAME:$USERNAME /FR3_VRInterface
...
COPY . /FR3_VRInterface/src
RUN sudo chown -R $USERNAME:$USERNAME /FR3_VRInterface \
    && sudo apt-get update \
    && rosdep update \
